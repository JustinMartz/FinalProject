...
INSERT INTO `comment` (`id`, `create_date`, `body`, `active`, `flagged`, `user_id`, `post_id`) VALUES (11, '2023-08-25 11:51:00', 'Journaling has been a game-changer for me. I write down my thoughts, moods, and any dreams I remember. It helps me be more self-aware and mindful throughout the day.', 1, 0, 4, 3);
INSERT INTO `comment` (`id`, `create_date`, `body`, `active`, `flagged`, `user_id`, `post_id`) VALUES (12, '2023-08-26 07:51:00', 'I’ve incorporated a gratitude practice into my mornings. Just listing three things I\'m thankful for can sometimes shift my mindset, even if I woke up feeling low.', 1, 0, 5, 3);
INSERT INTO `comment` (`id`, `create_date`, `body`, `active`, `flagged`, `user_id`, `post_id`) VALUES (13, '2023-08-26 07:55:00', 'I make a smoothie every morning filled with greens and fruits. It\'s a small thing, but taking care of my physical health has positive effects on my mental well-being too.\n\n', 1, 0, 6, 3);
INSERT INTO `comment` (`id`, `create_date`, `body`, `active`, `flagged`, `user_id`, `post_id`) VALUES (14, '2023-08-26 08:57:00', 'I\'ve tried multiple things over the years, but what consistently works for me is taking a few minutes to just sit in silence with my morning coffee. It\'s like a mini-meditation session for me.\n\n', 1, 0, 7, 3);
INSERT INTO `comment` (`id`, `create_date`, `body`, `active`, `flagged`, `user_id`, `post_id`) VALUES (15, '2023-08-28 08:57:00', 'Hey, late-night mania is a real struggle for me too. I find that turning off all screens and reading a physical book helps calm my racing thoughts.', 1, 0, 5, 4);
INSERT INTO `comment` (`id`, `create_date`, `body`, `active`, `flagged`, `user_id`, `post_id`) VALUES (16, '2023-08-28 08:58:00', 'Exercise is a double-edged sword for me. Sometimes it helps burn off excess energy, but other times it seems to fuel the fire. Timing is everything, I guess.', 1, 0, 4, 4);
INSERT INTO `comment` (`id`, `create_date`, `body`, `active`, `flagged`, `user_id`, `post_id`) VALUES (17, '2023-08-28 10:58:00', 'Herbal teas like chamomile have a mild sedative effect for me. Of course, it\'s no substitute for medication, but every little bit helps.', 1, 0, 6, 4);
INSERT INTO `comment` (`id`, `create_date`, `body`, `active`, `flagged`, `user_id`, `post_id`) VALUES (18, '2023-08-28 10:15:00', 'When nothing else works, I reach out to my support network or a helpline. Sometimes talking it out can help diffuse the manic energy.\n\n', 1, 0, 7, 4);
INSERT INTO `comment` (`id`, `create_date`, `body`, `active`, `flagged`, `user_id`, `post_id`) VALUES (19, '2023-08-28 10:20:00', 'I have a playlist of calming music and nature sounds. When mania hits, I listen to it on a low volume, which sometimes helps ease the rush.\n\n', 1, 0, 3, 4);
